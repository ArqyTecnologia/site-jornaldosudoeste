...
export default function PolíticasdePrivacidade() {
    return (
        <>
            <Head>
                <title>O Jornal - Políticas de Privacidade</title>
            ...
            <main className="w-full flex flex-col items-center justify-center">
                ...
                <div className="flex flex-col text-center p-8">
                    <h1 className="font-light text-2xl uppercase"> Políticas de Privacidade</h1>
                ...
                <div className="m-w-full items-center p-8 w-4/5 m-auto">
                    ...
                    <p className="text-justify lg:text-lg text-sm">
                        ...
                        A sua privacidade é importante para nós. É política do <strong>Jornal do Sudoeste</strong> respeitar a sua
                        privacidade em relação a qualquer informação sua que possamos coletar no site Jornal do
                        Sudoeste, e outros sites que possuímos e operamos. <br />
                        ...
                        Também informamos por que estamos coletando e como será usado. Apenas retemos as
                        informações coletadas pelo tempo necessário para fornecer o serviço solicitado. Quando
                        armazenamos dados, protegemos dentro de meios comercialmente aceitáveis para evitar perdas
                        e roubos, bem como acesso, divulgação, cópia, uso ou modificação não autorizados. Não
                        ...
                        responsabilidade por suas respectivas políticas de privacidade. Você é livre para recusar a nossa
                        solicitação de informações pessoais, entendendo que talvez não possamos fornecer alguns dos
                        serviços desejados.<br />
                        ...
                        veicular anúncios mais relevantes em toda a Web e limitar o número de vezes que um
                        ...
                        usados por este site foram projetados para garantir que você forneça os anúncios mais relevantes
                        ...
                        O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o <strong>Jornal do
                            Sudoeste</strong> oferece no site e com caráter enunciativo, mas não limitativo:<br />
                        A) Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;<br />
                        B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, kiwibet ou azar,
                        qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;<br />
                        C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Jornal do Sudoeste,
                        ...
                        Esta política é efetiva a partir de 29 April 2024 12:5
                        <br /><br />
                    </p>
